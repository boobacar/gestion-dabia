...
"[project]/src/components/TreatmentSettings.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TreatmentSettings() {
    ...
    const fetchTreatments = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useCallback({
        "TreatmentSettings.useCallback[fetchTreatments]": async ()=>{
            setLoading(true);
            try {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erreur lors du chargement des tarifs");
            } finally{
                setLoading(false);
            }
        }
    }["TreatmentSettings.useCallback[fetchTreatments]"], [
        supabase
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TreatmentSettings.useEffect": ()=>{
            fetchTreatments();
        }
    }["TreatmentSettings.useEffect"], [
        fetchTreatments
    ...
    const handleSave = async ()=>{
        if (!formData.name || !formData.price) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Veuillez remplir tous les champs obligatoires");
            return;
        }
        setSaving(true);
        try {
            ...
            if (editingId) {
                ...
                if (error) throw error;
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Soin mis à jour");
            } else {
                const { error } = await supabase.from("treatment_catalog").insert([
                    payload
                ]);
                if (error) throw error;
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Nouveau soin ajouté");
            }
            setIsModalOpen(false);
            fetchTreatments();
        } catch (err) {
            console.error("Error saving treatment:", err);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erreur lors de l'enregistrement");
        } finally{
            setSaving(false);
        }
    };
    const handleDelete = async (id)=>{
        ...
        try {
            ...
            if (error) throw error;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Soin supprimé");
            fetchTreatments();
        } catch (err) {
...
_s(TreatmentSettings, "5e/rdQNkjXsfPGF9hkQjOQgOowo=");
_c = TreatmentSettings;
var _c;
__turbopack_context__.k.register(_c, "TreatmentSettings");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TreatmentSettings$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/TreatmentSettings.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function SettingsPage() {
    ...
    const [clinicSettings, setClinicSettings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        name: "",
        specialty: "",
        address: "",
        phone: "",
                ...
                try {
                    ...
                    if (user) {
                        ...
                        if (profile) {
                            ...
                            // Use auth metadata if profile record doesn't exist yet
                            setUserProfile(initialProfile);
                        }
                    }
                } catch (err) {
                    console.error("Error fetching data:", err);
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erreur lors du chargement des paramètres");
                } finally{
                    setLoading(false);
                }
            }
    ...
    async function handleSaveClinic(e) {
        ...
        try {
            ...
            if (error) throw error;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Paramètres de la clinique enregistrés");
        } catch (err) {
    ...
    async function handleSaveProfile(e) {
        e.preventDefault();
        if (!userProfile.id) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("ID utilisateur manquant. Veuillez rafraîchir la page.");
            return;
        }
        if (!userProfile.email) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Email manquant.");
            return;
        }
        setSaving(true);
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Profil mis à jour avec succès");
        } catch (err) {
            console.error("Caught error saving profile:", err);
            const message = err instanceof Error ? err.message : err?.message || "Erreur inconnue";
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`Erreur lors de la mise à jour : ${message}`);
        } finally{
            setSaving(false);
        }
    }
    async function handleUpdatePassword(e) {
        ...
        if (passwords.new !== passwords.confirm) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Les mots de passe ne correspondent pas");
            return;
        }
        if (passwords.new.length < 6) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Le mot de passe doit contenir au moins 6 caractères");
            return;
        }
        setSaving(true);
        try {
            ...
            if (error) throw error;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Mot de passe modifié avec succès");
            setPasswords({
                new: "",
                confirm: ""
            });
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erreur lors du changement de mot de passe");
        } finally{
            setSaving(false);
        }
    }
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tabs"], {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TabsContent"], {
                        value: "treatments",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$TreatmentSettings$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TreatmentSettings"], {}, void 0, false, {
                            fileName: "[project]/src/app/admin/settings/page.tsx",
                            lineNumber: 354,
                            columnNumber: 11
                        }, this)
...
_s(SettingsPage, "nCeZfLCN+0nW80aPyXjZlkUk1tc=");
_c = SettingsPage;
var _c;
...
//# sourceMappingURL=src_eab20f37._.js.map