...
async function PatientsListPage(props) {
    ...
    if (q) {
        query = query.or(`first_name.ilike.%${q}%,last_name.ilike.%${q}%,patient_number.ilike.%${q}%,phone_number.ilike.%${q}%`);
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5a2fea29._.js.map