-- Rollback Phase 2 RLS hardening
-- Purpose: restore permissive/dev-style policies if strict RLS blocks the app
-- WARNING: this re-opens access broadly. Use only for emergency rollback.
