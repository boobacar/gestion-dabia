...
function MedicalHistoryForm({ patientId, initialHistory }) {
    ...
    const handleSave = async ()=>{
        ...
        if (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Erreur lors de l'enregistrement : " + error.message);
        } else {
...
//# sourceMappingURL=src_90667074._.js.map